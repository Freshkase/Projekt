...
public class DatenabrufStudent {
	...
	public ArrayList<Student> ausgeben() {
		...
		try {
			...
			ResultSet rs = anweisung.executeQuery("SELECT studenten.Anmeldename, studenten.Nachname, studenten.Vorname, studenten.Matrikelnummer, studenten.E_Mail, studenten.Name_Unternehmen, studenten.Bericht, studenten.Tätigkeitsnachweis, studenten.BPS_Vortrag, professoren.Professoren_ID, professoren.Nachname, professoren.Vorname, studenten.kennwort, studenten.Beginn_BPS, studenten.Ende_BPS FROM studenten, professoren WHERE studenten.Professoren_ID=professoren.Professoren_ID");

			while (rs.next()) {
				ausgabe.add(new Student(rs.getString(1), rs.getString(2), rs.getString(3), Integer.parseInt(rs.getString(4)), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), new Professor(Integer.parseInt(rs.getString(10)), rs.getString(11), rs.getString(12)), rs.getString(13), rs.getString(14), rs.getString(15)));
			}
