        			...
        			.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
        				.addGroup(gl_panel.createSequentialGroup()
        					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
        						.addComponent(matrikelnummerfix)
        						.addComponent(persoenlich)
        						.addGroup(gl_panel.createSequentialGroup()
        							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
        								.addComponent(nachnamefix)
        								.addComponent(mailfix)
        								.addComponent(vornamefix)
        							...
        							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
        								...
        								.addComponent(nummer)
        								.addComponent(mail)
        								.addComponent(nachname, GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE))
        				...
        				.addGroup(gl_panel.createSequentialGroup()
        					...
        					.addGap(203))
        				.addGroup(gl_panel.createSequentialGroup()
        					.addComponent(beschreibung, 422, 422, 422)
        					.addGap(203))
        				.addGroup(gl_panel.createSequentialGroup()
        					.addComponent(taetigkeitfix)
        				...
        				.addGroup(gl_panel.createSequentialGroup()
        					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
        						.addGroup(gl_panel.createSequentialGroup()
        							...
        							.addComponent(themenbereich, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE))
        						.addGroup(gl_panel.createSequentialGroup()
        							.addComponent(telefonfix)
        							.addPreferredGap(ComponentPlacement.RELATED, 105, Short.MAX_VALUE)
        							.addComponent(telefon, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE))
        						.addGroup(gl_panel.createSequentialGroup()
        							.addComponent(abteilungfix)
        							.addPreferredGap(ComponentPlacement.RELATED, 95, Short.MAX_VALUE)
        							.addComponent(abteilung, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE))
        						.addGroup(gl_panel.createSequentialGroup()
        							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
        								.addComponent(unternehmenfix)
        								.addComponent(firmenanschriftfix))
        							.addGap(66)
        							.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
        								.addComponent(firmenanschrift, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE)
        								.addComponent(unternehmenname, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE)))
        						.addGroup(gl_panel.createSequentialGroup()
        							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
        								.addComponent(urlfix)
        								.addComponent(firmenbetreuerfix))
        							.addGap(24)
        							.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
        						...
        						.addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup()
        							...
        							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
        								.addGroup(gl_panel.createSequentialGroup()
        									...
        									.addPreferredGap(ComponentPlacement.RELATED)
        									.addComponent(ende, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE))
        								.addComponent(mailunternehmen, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE))))
        ...
        gl_panel.setVerticalGroup(
        	gl_panel.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_panel.createSequentialGroup()
        			...
        			.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
        				.addComponent(matrikelnummerfix)
        				.addComponent(nummer, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
        			...
        			.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
        				.addComponent(urlfix)
        				.addComponent(url, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE))
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
        				.addComponent(firmenbetreuerfix)
