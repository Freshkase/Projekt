...
public class StudentGUI extends JPanel {
    ...
    public StudentGUI() {
        ...
        if(ausgabe.get(tmp).getProf().getId()==0) {
        	...
        	lblNewLabel = new JLabel(ausgabe.get(tmp).getProf().getNachname() + ", " + ausgabe.get(tmp).getProf().getVorname());
        }
        ...
        groupLayout.setHorizontalGroup(
        	groupLayout.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(groupLayout.createSequentialGroup()
        			...
        			.addComponent(scrollbar, GroupLayout.PREFERRED_SIZE, 470, GroupLayout.PREFERRED_SIZE)
        			.addContainerGap())
        		.addGroup(groupLayout.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(status)
