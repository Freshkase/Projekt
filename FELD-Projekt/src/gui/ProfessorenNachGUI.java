					...
					for (int i = 0; i <= unternehmenls.size() - 1; i++) {
						if (verkuerzt.get(buttonRow).getAnmeldename()
							...
							String message = "<html>"
								    ...
								    + "<tr><td style='vertical-align: top'><b>Beschreibung:</b></td><td style='vertical-align: top'><div style='width: 200px; word-wrap: break-word;'>" + unternehmenls.get(i).getBeschreibung() + "</div></td></tr>"
								    + "</table>"
								    + "</html>";
